#pragma once
//có một số hàm thêm vào để mọi người có thế sử dụng lại
#include <stdio.h>
#include <conio.h>
#include <windows.h>
...
// Lấy nút bàn phím do người dùng bấm và trả về mã phím
int inputKey() {
	if (_kbhit()) {
		int key = _getch();
		if (key == 224) {
...
// Đổi màu chữ bằng mã màu
void setTextColor(int color) {
	SetConsoleTextAttribute(GetStdHandle(STD_OUTPUT_HANDLE), color);
}
//tạo chiều cao và chiều rộng console, mình thích để width = 1000, height = 500
